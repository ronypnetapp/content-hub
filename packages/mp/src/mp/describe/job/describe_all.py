...
async def describe_all_jobs(
    ...
    *,
    ...
    """Describe all jobs in all integrations in the marketplace or specific ones."""
...
class _MarketplaceOrchestrator(MarketplaceOrchestratorBase):
    def _create_describer(self, integration_name: str) -> DescribeJob:
        return DescribeJob(
