...
class JobAiMetadata(BaseModel):
    ai_description: Annotated[
        ...
        Field(
            description=(
                "Detailed description that will be used by LLMs to understand what the job"
                " does. This should be a concise yet informative summary of the job's"
                " purpose, and the expected outcome."
                " Use markdown formatting for clarity, as this is a description for LLMs."
                " Please add a description of the flow of the job in numbered or bulleted"
